...
var DOMKeyframesResolver = class extends KeyframeResolver {
  ...
  measureEndState() {
    ...
    if (name === "height" && this.suspendedScrollY !== void 0) {
...
var BaseAnimation = class {
  ...
  onKeyframesResolved(keyframes2, finalKeyframe) {
    const { name, type, velocity, delay: delay2, onComplete, onUpdate } = this.options;
    ...
    this._resolved = {
      ...
      finalKeyframe,
      ...this.initPlayback(keyframes2, finalKeyframe)
    };
    this.onPostResolved();
  }
  onPostResolved() {
...
var MainThreadAnimation = class extends BaseAnimation {
  ...
  tick(timestamp, sample = false) {
    const { finalKeyframe, generator, mirroredGenerator, mapPercentToKeyframes, keyframes: keyframes2, calculatedDuration, totalDuration, resolvedDuration } = this.resolved;
...
var AcceleratedAnimation = class extends BaseAnimation {
  ...
  initPlayback(keyframes2, finalKeyframe) {
    ...
    const { motionValue: motionValue2, name } = this.options;
    const animation = animateStyle(motionValue2.owner.current, name, keyframes2, { ...this.options, duration });
  ...
  stop() {
    this.isStopped = true;
    const { animation, keyframes: keyframes2 } = this.resolved;
    ...
    if (this.time) {
      ...
      motionValue2.setWithVelocity(sampleAnimation.sample(this.time - sampleDelta).value, sampleAnimation.sample(this.time).value, sampleDelta);
    }
    this.cancel();
  }
  complete() {
